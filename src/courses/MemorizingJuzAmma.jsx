  ...
  return (
    <div className="max-w-full mx-auto">
      ...
      <div className="relative w-full h-[300px] overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-secondary-900/80 to-secondary-800/60 flex items-center w-full">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="md:col-span-2">
            <div className="bg-white rounded-xl shadow-md p-6 mb-8">
              <h2 className="text-2xl font-bold text-secondary-800 mb-4">Course Description</h2>
            ...
            <div className="bg-white rounded-xl shadow-md p-6">
              <h2 className="text-2xl font-bold text-secondary-800 mb-4">Course Highlights</h2>
