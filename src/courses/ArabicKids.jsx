      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid md:grid-cols-3 gap-8">
          <div className="md:col-span-2">
            ...
            {/* Course Outline */}
            <div className="bg-white rounded-xl shadow-md p-6 mb-8">
              <h2 className="text-2xl font-bold text-secondary-800 mb-4">Course Outline</h2>
              <div className="grid sm:grid-cols-2 gap-6">
                <div className="bg-secondary-50 p-4 rounded-lg border-l-4 border-secondary-600">
                  <h3 className="font-semibold text-secondary-800 mb-2">Arabic Reading Skills</h3>
                ...
                <div className="bg-purple-50 p-4 rounded-lg border-l-4 border-purple-500">
                  ...
                  <ul className="text-gray-700 space-y-2">
                    ...
                    <li className="flex items-start">
                      <span className="text-purple-600 mr-2">•</span>
                      <span>secondary expressions</span>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="bg-white rounded-xl shadow-md p-6">
              <h2 className="text-2xl font-bold text-secondary-800 mb-4">By The End Of This Course</h2>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-md p-6">
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <Link to="/courses/reading" className="text-secondary-600 hover:text-secondary-800 hover:underline">
