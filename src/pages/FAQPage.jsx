...
const FAQPage = () => {
  ...
  <div className="space-y-8">
    ...
    <div className="bg-white rounded-xl shadow-md overflow-hidden border border-gray-100">
      <div className="p-6">
        <h3 className="text-xl font-bold text-green-800 mb-2">What is NebrasAcademy.com?</h3>
        <p className="text-gray-700">
          Nebras Academy is an online Quran and Islamic studies platform that connects students with qualified teachers worldwide. We offer personalized one-on-one and small group classes for children, adults, and families.
        </p>
      </div>
    </div>
    ...
    <div className="bg-white rounded-xl shadow-md overflow-hidden border border-gray-100">
      <div className="p-6">
        <h3 className="text-xl font-bold text-green-800 mb-2">Who are your teachers?</h3>
        <p className="text-gray-700">
          All our teachers are highly qualified, university-educated instructors with ijazah (certification) in Quran or Islamic sciences. They are fluent in English, Arabic, and often other languages to ensure effective communication.
        </p>
      </div>
    </div>
    ...
    <div className="bg-white rounded-xl shadow-md overflow-hidden border border-gray-100">
      <div className="p-6">
        <h3 className="text-xl font-bold text-green-800 mb-2">What courses do you offer?</h3>
        ...
        <ul className="grid md:grid-cols-2 gap-2 text-gray-700">
          ...
          <li className="flex items-start">
            <span className="text-amber-500 mr-2">•</span>
            <span>Islamic Studies for Kids & Adults</span>
          </li>
        </ul>
    ...
    <div className="bg-white rounded-xl shadow-md overflow-hidden border border-gray-100">
      <div className="p-6">
        <h3 className="text-xl font-bold text-green-800 mb-2">How does the trial class work?</h3>
        <p className="text-gray-700">
    ...
    <div className="bg-white rounded-xl shadow-md overflow-hidden border border-gray-100">
      <div className="p-6">
        <h3 className="text-xl font-bold text-green-800 mb-2">Do you offer classes for kids?</h3>
        <p className="text-gray-700">
    ...
    <div className="bg-white rounded-xl shadow-md overflow-hidden border border-gray-100">
      <div className="p-6">
        <h3 className="text-xl font-bold text-green-800 mb-2">What is an Ijazah?</h3>
        <p className="text-gray-700">
    ...
    <div className="bg-white rounded-xl shadow-md overflow-hidden border border-gray-100">
      <div className="p-6">
        <h3 className="text-xl font-bold text-green-800 mb-2">How is Nebras Academy different?</h3>
        <p className="text-gray-700">
    ...
    {/* قسم الحجز */}
    <div className="bg-gradient-to-r from-green-600 to-green-700 rounded-xl p-8 text-center mt-12">
