    ...
    <section className="py-16 px-4 bg-white">
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          {courses.map((course, index) => (
            <div key={index} className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition duration-300 border border-gray-100">
              ...
              />
              <div className="p-6">
                <h3 className="text-xl font-bold text-orange-500 mb-3">{course.title}</h3>
                <p className="text-gray-600 mb-4">{course.description}</p>
                <Link to="/courses" className="text-islamic-500 font-semibold hover:text-orange-600 transition duration-300">
                  Learn More →
                </Link>
              </div>
            </div>
        ...
        <div className="text-center">
          <Link to="/courses" className="bg-orange-500 hover:bg-orange-600 text-white font-bold py-3 px-8 rounded-full inline-flex items-center transition duration-300 shadow-lg">
            VIEW MORE COURSES
